...
msgs = {
	"close": require('../messages/close'),
	"create": require('../messages/create'),
	"create_folder": require('../messages/create_folder'),
	"negotiate": require('../messages/negotiate'),	
	"open": require('../messages/open'),
	"open_folder": require('../messages/open_folder'),
	"query_directory": require('../messages/query_directory'),
	"read": require('../messages/read'),
	"session_setup_step1": require('../messages/session_setup_step1'),
	"session_setup_step2": require('../messages/session_setup_step2'),
	"set_info": require('../messages/set_info'),
	"tree_connect": require('../messages/tree_connect'),
	"write": require('../messages/write')
}
